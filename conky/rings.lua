...
gauge = {
{
    ...
    graph_unit_angle=2.7,          graph_unit_thickness=1.7,
...
--},
{
    ...
    graph_unit_angle=1.8,          graph_unit_thickness=1.7,
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.2,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.8,
    hand_fg_colour=0x1793D0,       hand_fg_alpha=1.0,
    txt_radius=0,
...
{
    name='fs_used_perc',           arg='/media/Vault',                     max_value=100,
    x=35,                          y=550,
    graph_radius=30,
    graph_thickness=8,
    graph_start_angle=180,
...
},
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.2,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.8,
    hand_fg_colour=0x1793D0,       hand_fg_alpha=0,
    txt_radius=0,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_colour=0x1793D0,        txt_fg_alpha=1.0,
    graduation_radius=28,
